...
func (_m *SlackSender) Ack(_a0 socketmode.Request, _a1 ...any) {
	var _ca []interface{}
	_ca = append(_ca, _a0)
	_ca = append(_ca, _a1...)
	_m.Called(_ca...)
...
// SlackSender_Ack_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Ack'
type SlackSender_Ack_Call struct {
	*mock.Call
}

// Ack is a helper method to define mock.On call
//   - _a0 socketmode.Request
//   - _a1 ...any
func (_e *SlackSender_Expecter) Ack(_a0 interface{}, _a1 ...interface{}) *SlackSender_Ack_Call {
	return &SlackSender_Ack_Call{Call: _e.mock.On("Ack",
		append([]interface{}{_a0}, _a1...)...)}
}

func (_c *SlackSender_Ack_Call) Run(run func(_a0 socketmode.Request, _a1 ...any)) *SlackSender_Ack_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(socketmode.Request), variadicArgs...)
	})
	return _c
}

func (_c *SlackSender_Ack_Call) Return() *SlackSender_Ack_Call {
	_c.Call.Return()
	return _c
}

func (_c *SlackSender_Ack_Call) RunAndReturn(run func(socketmode.Request, ...any)) *SlackSender_Ack_Call {
	_c.Call.Return(run)
	return _c
}
