...
func Test_evalHomeRule(t *testing.T) {
	...
	assert.NoError(t, evalHomeRule(&output, v)(nil, []string{"../../internal/controller/rules/homerules/homeandaway.lua"}))
...
func Test_evalZoneRule(t *testing.T) {
	...
	assert.NoError(t, evalZoneRule(&output, v)(nil, []string{"../../internal/controller/rules/zonerules/limitoverlay.lua"}))
